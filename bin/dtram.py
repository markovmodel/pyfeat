...
####################################################################################################
#                                                                                                  #
#   RUN SCRIPT FOR THE DTRAM METHOD WITHIN THE PYFEAT package                                      #
#                                                                                                  #
...
if '__main__' == __name__:
    ...
    try:
        dtram_obj = DTRAM( forge.get_C_K_ij( args.lag ), forge.b_K_i )
    ...
    print "#\n#                  Thank you for using dTRAM in the pyfeat package!\n#\n#"
    print "#\n################################################################################################\n\n"
